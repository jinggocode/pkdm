...
(function (window, undefined) {
	...
	var jQuery = (function () {
		...
		jQuery.extend({
			...
			// Convert dashed to camelCase; used by the cssbody and data modules
	...
	if (!jQuery.support.style) {
		jQuery.attrHooks.style = {
			get: function (elem) {
				...
				// Normalize to lowercase since IE uppercases cssbody property names
 ...
 */
	...
	jQuery.extend({
		...
		// Exclude the following cssbody properties to add px
		cssNumber: {
			"fillOpacity": true,
			"fontWeight": true,
			"lineHeight": true,
		...
		cssProps: {
			// normalize float cssbody property
	...
	// DEPRECATED, Use jQuery.cssbody() instead
		...
		jQuery.cssHooks.opacity = {
			...
			set: function (elem, value) {
				...
				if (value >= 1 && jQuery.trim(filter.replace(ralpha, "")) === "") {
					...
					// if there there is no filter style applied in a cssbody rule, we are done
	...
	function getWH(elem, name, extra) {
		...
		// Fall back to computed then uncomputed cssbody if necessary
