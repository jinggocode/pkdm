...
<section class="content-header">
  <h1>
    Edit Data Kategori Pertanyaan Kuesioner
  </h1>
</section>
...
<section class="content">
  ...
  <div class="box-header with-border">
    ...
    <div class="box-body">
      ...
      <form class="form-horizontal" action="{{site_url('admin/kuesioner/kategori/update')}}" method="post" enctype="multipart/form-data">
      {{$csrf}}
