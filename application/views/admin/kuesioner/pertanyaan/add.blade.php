...
<section class="content">
  ...
  <div class="box-header with-border">
    ...
    <div class="box-body">
      ...
      <form class="form-horizontal" action="{{site_url('admin/kuesioner/pertanyaan/save')}}" method="post" enctype="multipart/form-data">
      {{$csrf}}
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <select required name="jenis_jawaban" id="jenis_jawaban" class="form-control">
              ...
              <option {{('0' == set_value('jenis_jawaban')?'selected':'')}} value="0">Ya / Tidak</option>
              <option {{('1' == set_value('jenis_jawaban')?'selected':'')}} value="1">Kepuasan</option>
            </select>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <select required name="jenis" id="jenis" class="form-control">
              ...
              <option {{('0' == set_value('jenis')?'selected':'')}} value="0">TEORI</option>
              <option {{('1' == set_value('jenis')?'selected':'')}} value="1">PRAKTIKUM</option>
            </select>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input type="text" name="isi" class="form-control" value="{{set_value('isi')}}" id="isi">
          </div>
        </div>
        <div class="form-group">
