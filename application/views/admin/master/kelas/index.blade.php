...
@section('content')
    ...
    <section class="content">
      ...
      <div class="box-header with-border">
        <a href="{{site_url('admin/master/kelas/add')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
      </div>
        <div class="box-body">
          <div class="row">
            <div class="col-lg-6 col-md-6">
                <form class="form-inline" action="{{site_url('admin/master/kelas/search')}}" method="get">
