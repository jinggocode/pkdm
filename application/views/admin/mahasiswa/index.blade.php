...
@section('content')
    ...
    <section class="content">
      ...
      <div class="box-header with-border">
        <a href="{{site_url('admin/mahasiswa/add')}}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Data</a>
        <a href="{{site_url('admin/mahasiswa/import')}}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Import Data Excel</a>
      </div>
        <div class="box-body">
          <div class="row">
              ...
              <?php else: ?>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{site_url('admin/mahasiswa/delete/'.$row->id)}}" onclick="return confirm('apakah anda yakin?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
                    </td>
                  </tr>
                  @endforeach 
              <?php endif ?>
