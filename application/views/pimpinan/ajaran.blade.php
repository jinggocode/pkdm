...
<div class="box box-default">
  <div class="box-header with-border">
    <center>
        <a href="{{site_url('pimpinan/homepage')}}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
    </center> 
      ...
      <?php else: ?>
          ...
          @foreach($tahun_ajaran as $row)  
            <tr>
              ...
              <td> 
                  <a href="{{site_url('pimpinan/statistik/index/'.$row->id_periode.'/'.$id_prodi)}}" class="btn btn-info"><i class="fa fa-send"></i> Lihat</a>
              </td>
            </tr>
          @endforeach
      <?php endif ?>
